#pragma once
		...
		#define dwForceAttack   0x31D44D4 
		#define dwForceAttack2   0x31D44E0 
		#define dwForceBackward   0x31D448C 
		#define dwForceForward   0x31D44F8 
		#define dwForceJump   0x524CEA4 
		#define dwForceLeft   0x31D4480 
		#define dwForceRight   0x31D44A4 
		#define dwGameDir   0x62D7F8 
		#define dwGameRulesProxy   0x52C018C 
		#define dwGetAllClasses   0xDB2F8C 
		#define dwGlobalVars   0x58ECE8 
		#define dwGlowObjectManager   0x52EB540 
		#define dwInput   0x51F4528 
		#define dwInterfaceLinkList   0x9457A4 
		#define dwLocalPlayer   0xD8B2BC 
		#define dwMouseEnable   0xD90E60 
		#define dwMouseEnablePtr   0xD90E30 
		#define dwPlayerResource   0x31D2800 
		#define dwRadarBase   0x51D7CBC 
		#define dwSensitivity   0xD90CFC 
		#define dwSensitivityPtr   0xD90CD0 
		#define dwSetClanTag   0x8A1A0 
		#define dwViewMatrix   0x4D94844 
		#define dwWeaponTable   0x51F4FE8 
		#define dwWeaponTableIndex   0x325C 
		#define dwYawPtr   0xD90AC0 
		#define dwZoomSensitivityRatioPtr   0xD95D60 
		#define dwbSendPackets   0xD73EA 
		#define dwppDirect3DDevice9   0xA7050 
		#define find_hud_element   0x2E15E320 
		...
		#define m_pitchClassPtr   0x51D7F58 
		#define m_yawClassPtr   0xD90AC0 
